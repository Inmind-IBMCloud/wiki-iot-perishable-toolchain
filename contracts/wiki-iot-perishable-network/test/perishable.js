...
const namespace = 'org.acme.shipping.wiki_perishable';
...
describe('Perishable Shipping Network', () => {
    ...
    describe('#shipment', () => {
        ...
        it('should receive base price for a shipment within temperature range', async () => {
            ...
            tempReading.celsius = 4.5;
            tempReading.latitude = '40.6840';
            tempReading.longitude = '74.0062';
            tempReading.readingTime = '2018-03-22T17:31:36.229Z';
